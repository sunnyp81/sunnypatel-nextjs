...
const FAQS = [
  ...
  {
    q: "Is a GEO agency the same as an AEO agency?",
    a: "In practice, yes. AEO (Answer Engine Optimisation) and GEO (Generative Engine Optimisation) describe the same goal: getting your brand included and cited in AI-generated answers. Some providers use AEO to emphasise answer engines like ChatGPT and Perplexity, and GEO to emphasise the generative layer in Google's AI Overviews, but a competent provider covers both under one methodology. Judge the work, not the acronym.",
  },
  {
