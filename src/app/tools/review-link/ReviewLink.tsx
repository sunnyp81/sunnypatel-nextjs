...
const inputClass =
  'w-full rounded-lg border border-black/[0.08] dark:border-white/[0.08] bg-wash px-3 py-2.5 text-sm text-foreground placeholder:text-muted-foreground focus:border-brand/50 focus:outline-none focus:ring-1 focus:ring-brand/30';
const labelClass = 'block text-sm font-medium text-foreground mb-1.5';
const cardClass = 'rounded-xl border border-hairline bg-wash p-6';
const btnPrimary =
...
const btnSecondary =
  'rounded-lg border border-black/[0.12] dark:border-white/[0.12] bg-black/[0.04] dark:bg-white/[0.04] px-4 py-2.5 text-sm font-medium text-foreground hover:bg-black/[0.06] dark:hover:bg-white/[0.08] transition-colors';
const urlDisplayClass =
  'bg-surface-2 dark:bg-[#0d0d14] border border-black/[0.08] dark:border-white/[0.08] p-4 rounded-lg font-mono text-sm break-all';
const templateCardClass =
  'relative rounded-lg border border-black/[0.08] dark:border-white/[0.08] bg-wash p-4';
...
function StepBadge({ step }: { step: number }) {
  return (
    <span className="inline-flex h-7 w-7 items-center justify-center rounded-full bg-brand/15 text-brand-ink text-xs font-bold shrink-0">
      {step}
    </span>
  );
}
    ...
    <button onClick={handleCopy} className={btnSecondary}>
      {copied ? (
        <span className="flex items-center gap-1.5">
          <svg className="h-4 w-4 text-green-700 dark:text-green-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className={urlDisplayClass}>
                    <span className="text-brand-ink">{reviewUrl}</span>
                  </div>
                ...
                <div className={templateCardClass}>
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center gap-2">
                      <svg className="h-4 w-4 text-brand-ink" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={item.title} className="flex gap-3">
                  <svg className="h-5 w-5 text-brand-ink shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          ...
          <div className={cardClass}>
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={item.title} className="flex gap-3">
                  <svg className="h-5 w-5 text-brand-ink/60 shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
