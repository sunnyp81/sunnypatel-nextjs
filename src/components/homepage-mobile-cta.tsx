...
export function HomepageMobileCta() {
  ...
  return (
    <aside aria-label="Quick contact options" className="fixed inset-x-3 bottom-3 z-50 rounded-2xl border border-hairline-strong bg-surface-1/95 p-2 shadow-[var(--elev)] backdrop-blur-xl md:hidden dark:border-white/15 dark:bg-[#08080d]/95 dark:shadow-[0_15px_50px_rgba(0,0,0,0.6)]" style={{ paddingBottom: "max(0.5rem, env(safe-area-inset-bottom))" }}>
