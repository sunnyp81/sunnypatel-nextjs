export function Stats() {
  const stats = [
    { value: "280%", label: "Avg Traffic Increase", color: "from-[#5B8AEF] to-[#d79f1e]" },
    ...
    { value: "15+", label: "Years Experience", color: "from-[#4c7894] to-[#5B8AEF]" },
  ];
  ...
  return (
    <section className="relative py-20 overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at center, #5B8AEF, transparent 60%)",
        }}
      />
