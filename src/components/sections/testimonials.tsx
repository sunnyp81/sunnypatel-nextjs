...
export function Testimonials() {
  return (
    <section className="relative overflow-hidden border-t border-hairline bg-surface-1 dark:border-white/[0.05] dark:bg-[#050507]">
      ...
      <div className="relative mx-auto max-w-4xl px-6 py-20">
        <p className="mb-3 text-center text-xs font-semibold uppercase tracking-widest text-brand-ink">Verified Client Result</p>
        ...
        {TESTIMONIALS.map((testimonial) => (
          <figure key={testimonial.author} className="relative rounded-2xl border border-hairline-strong bg-surface-2 p-7 shadow-[var(--elev)] md:p-9 dark:border-white/[0.09] dark:bg-white/[0.03] dark:shadow-none">
            <Quote className="mb-5 h-6 w-6 text-brand-ink" aria-hidden="true" />
