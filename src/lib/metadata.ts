...
const DEFAULT_TITLE = "Sunny Patel — UK SEO Consultant | 150%+ Organic Growth";
const DEFAULT_DESCRIPTION =
  "Independent UK SEO consultant. 15+ years delivering 150-280% organic growth for professional services, healthcare & local businesses. Free 30-min audit.";
